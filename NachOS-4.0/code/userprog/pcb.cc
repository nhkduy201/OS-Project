#include "../userprog/pcb.h"
#include "../../code/lib/utility.h"
#include "system.h"
#include "thread. h"
#include "addrspace.h"

extern void StartProcess 2(int id);
...
int PCB ::GetNumWait() { return thisl->numwait; }
...
int PCB : Exec(char *filename, int id)
{
    ...
    this->parent ID = current Thread->process ID;
